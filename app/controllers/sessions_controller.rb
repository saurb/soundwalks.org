...
class SessionsController < ApplicationController
  ...
  def create
    ...
    if user
      # Protects against session fixation attacks: causes request forgery protection if user resubmits an earlier form
      # using the back button. Uncomment if you understand the tradeoffs.
      # reset_session
